    ...
    <div class="wrapper1 md:w-[77%] lg:w-[77%]">
        <div class="anime-content md:my-2 p-2 md:w-[100%] md:border-2 border-gray-500">
            @foreach ($data as $item)
                <div class="anime-content md:my-2 p-2 md:w-[100%] md:border-2 border-gray-500">
                    <a href="{{route('MangablogPage.dataFetch',$item->id)}}" class="md:flex md:flex-row">
                        <div class="anime-image md:p-0 h-54 md:w-[50%] lg:w-[50%] md:h-38 lg:h-56">
                            <img src="thumbnail/manga_thumbnail/{{$item->thumbnail_url}}" class="w-[100%] h-full object-cover" alt="">
                        </div>
                        <div class="anime-news p-2 md:w-[50%] lg:w-[50%]">
                            <p class="font-semibold text-xl + lg:text-3xl ">{{$item->Manga_title}}</p>
